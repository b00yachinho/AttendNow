                ...
                <div class="text-center mp_content">
                    ...
                    <nav class="mb-3 mp_nav">
                        <ul class="list-unstyled mp_nav_ul">
                          ...
                          <li class="mp_nav_li"><a href="search.php" class="mp_nav_li_a">Popularne</a></li>
                    ...
                    <form class="d-flex justify-content-center">
                        ...
                        <button class="btn" type="submit"><a href="search.php" class="nav-item nav-link" style="">Szukaj</a></button>
                    </form>
                </div>
