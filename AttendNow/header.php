        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="search.php" class="nav-item nav-link">Popularne</a>
              ...
              <div class="modal-dialog modal-dialog-end modal-lg">
                <div class="modal-content">
                  ...
                  <div class="leftOption modal-content card" style="height:50%; height:20em;">
                    ...
                    <button class="btn-warning" id="choose"><a href="admin_dashboard.php" class="nav-item nav-link" style="color:#5d3f58">Admin panel</button></a>
                    <button class="btn-warning" id="choose"><a href="add_event.php" class="nav-item nav-link" style="color:#5d3f58">Dodaj event</button></a>
                  </div>
