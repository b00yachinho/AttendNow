    ...
    ?>      
      <div class="wrapper">
            <div class="content-left">
                ...
                <div class="bottom-left inOneLine" style="margin-left:3em;">
                    <img src="example/2.jpg" alt="Product photo">
                    <img src="example/3.jpg" alt="Product photo">
            ...
            <div class="content-right">
                    <div class="right-aboutProduct">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#user" class="colorButtonModal infoAuthor" id="openModal" style="background-color: transparent; border:none; color:white; text-decoration:underline;">Informacje o autorze</button><br>
